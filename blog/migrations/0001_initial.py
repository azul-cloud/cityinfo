...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('blog_blogpost_tags')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('blog_blogpost_tags'))
    ...
    models = {
        ...
        'blog.blogpost': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['blog.Tag']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
