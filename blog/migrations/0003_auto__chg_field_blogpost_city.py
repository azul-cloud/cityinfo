...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogPost.city'
        db.alter_column('blog_blogpost', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['region.City']))

    def backwards(self, orm):

        # Changing field 'BlogPost.city'
        db.alter_column('blog_blogpost', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.City']))
    ...
    models = {
        ...
        'blog.blogpost': {
            'Meta': {'object_name': 'BlogPost', 'unique_together': "(('city', 'slug'),)"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['main.User']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['region.City']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'headline': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'to': "orm['blog.Tag']", 'symmetrical': 'False'}),
