...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_city', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Country'], default=1),
                      keep_default=False)
    ...
    models = {
        ...
        'main.user': {
            ...
            'contributor': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True', 'default': 'False'}),
