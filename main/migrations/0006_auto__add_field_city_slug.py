...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_city', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='medellin', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.slug'
        db.delete_column('main_city', 'slug')
    ...
    models = {
        ...
        'main.user': {
            ...
            'contributor': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
