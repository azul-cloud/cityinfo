...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_user', (
            ...
            ('contributor', self.gf('django.db.models.fields.NullBooleanField')(default=False, blank=True, null=True)),
        ))
        db.send_create_signal('main', ['User'])

        # Adding M2M table for field groups on 'User'
        m2m_table_name = db.shorten_name('main_user_groups')
        ...
        m2m_table_name = db.shorten_name('main_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm['main.user'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('main_user_groups'))

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table(db.shorten_name('main_user_user_permissions'))
