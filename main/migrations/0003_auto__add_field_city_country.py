...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_city', 'country',
                      self.gf('django.db.models.fields.CharField')(default='COL', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.country'
        db.delete_column('main_city', 'country')
    ...
    models = {
        ...
        'main.city': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '30'})
        },
        'main.user': {
            'Meta': {'object_name': 'User'},
            'contributor': ('django.db.models.fields.NullBooleanField', [], {'blank': 'True', 'default': 'False', 'null': 'True'}),
