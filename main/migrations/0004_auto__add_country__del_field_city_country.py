...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_city', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=3, default=1),
                      keep_default=False)
    ...
    models = {
        ...
        'main.user': {
            ...
            'contributor': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'default': 'False', 'blank': 'True'}),
